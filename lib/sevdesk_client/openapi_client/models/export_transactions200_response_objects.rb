...
module OpenapiClient
  class ExportTransactions200ResponseObjects
    attr_accessor :filename

    attr_accessor :mimetype

    attr_accessor :base64_encoded
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ExportTransactions200ResponseObjects` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ExportTransactions200ResponseObjects`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'base64_encoded')
        self.base64_encoded = attributes[:'base64_encoded']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          filename == o.filename &&
          mimetype == o.mimetype &&
          base64_encoded == o.base64_encoded &&
          content == o.content
    end
    ...
    def hash
      [filename, mimetype, base64_encoded, content].hash
    end
