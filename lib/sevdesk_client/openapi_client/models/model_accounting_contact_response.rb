...
module OpenapiClient
  ...
  class ModelAccountingContactResponse
    ...
    attr_accessor :debitor_number

    # Creditor number of the accounting contact.
    attr_accessor :creditor_number
    ...
    def self.openapi_types
      {
        ...
        :'create' => :'Time',
        :'update' => :'Time',
        :'contact' => :'ModelAccountingContactResponseContact',
        :'sev_client' => :'ModelAccountingContactResponseSevClient',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelAccountingContactResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelAccountingContactResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'debitor_number')
        self.debitor_number = attributes[:'debitor_number']
      end

      if attributes.key?(:'creditor_number')
        self.creditor_number = attributes[:'creditor_number']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          debitor_number == o.debitor_number &&
          creditor_number == o.creditor_number
    end
    ...
    def hash
      [id, object_name, create, update, contact, sev_client, debitor_number, creditor_number].hash
    end
