  ...
  class ModelVoucher
    ...
    def self.openapi_types
      {
        ...
        :'create' => :'Time',
        :'update' => :'Time',
        :'sev_client' => :'ModelVoucherSevClient',
        :'create_user' => :'ModelVoucherCreateUser',
        :'voucher_date' => :'Time',
        :'supplier' => :'ModelVoucherSupplier',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelVoucher` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelVoucher`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @credit_debit.nil?
        invalid_properties.push('invalid value for "credit_debit", credit_debit cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @credit_debit.nil?
    ...
    def hash
      [id, object_name, map_all, create, update, sev_client, create_user, voucher_date, supplier, supplier_name, description, pay_date, status, sum_net, sum_tax, sum_gross, sum_net_accounting, sum_tax_accounting, sum_gross_accounting, sum_discounts, sum_discounts_foreign_currency, paid_amount, tax_rule, tax_type, credit_debit, voucher_type, currency, property_foreign_currency_deadline, property_exchange_rate, recurring_interval, recurring_start_date, recurring_next_voucher, recurring_last_voucher, recurring_end_date, enshrined, tax_set, payment_deadline, delivery_date, delivery_date_until, document, cost_centre].hash
    end
