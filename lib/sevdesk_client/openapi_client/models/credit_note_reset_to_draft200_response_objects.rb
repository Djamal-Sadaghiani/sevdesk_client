...
module OpenapiClient
  class CreditNoteResetToDraft200ResponseObjects
    # The creditNote id
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'contact' => :'ModelCreditNoteResponseContact',
        :'credit_note_date' => :'Time',
        :'status' => :'String',
        :'header' => :'String',
        :'head_text' => :'String',
        :'foot_text' => :'String',
        :'address_country' => :'ModelCreditNoteResponseAddressCountry',
        :'create_user' => :'ModelCreditNoteResponseCreateUser',
        :'sev_client' => :'ModelCreditNoteResponseSevClient',
        :'delivery_date' => :'Time',
        :'small_settlement' => :'Boolean',
        :'contact_person' => :'ModelCreditNoteResponseContactPerson',
        :'tax_rate' => :'String',
        :'tax_rule' => :'ModelCreditNoteResponseTaxRule',
        :'tax_set' => :'ModelCreditNoteResponseTaxSet',
        :'tax_text' => :'Object',
        :'tax_type' => :'String',
        :'send_date' => :'Time',
        :'address' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CreditNoteResetToDraft200ResponseObjects` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CreditNoteResetToDraft200ResponseObjects`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["100", "200", "750", "1000"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["100", "200", "750", "1000"])
    ...
    def hash
      [id, object_name, create, update, credit_note_number, contact, credit_note_date, status, header, head_text, foot_text, address_country, create_user, sev_client, delivery_date, small_settlement, contact_person, tax_rate, tax_rule, tax_set, tax_text, tax_type, send_date, address, currency, sum_net, sum_tax, sum_gross, sum_discounts, sum_net_foreign_currency, sum_tax_foreign_currency, sum_gross_foreign_currency, sum_discounts_foreign_currency, customer_internal_note, show_net, send_type].hash
    end
