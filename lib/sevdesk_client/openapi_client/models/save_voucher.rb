...
module OpenapiClient
  class SaveVoucher
    ...
    attr_accessor :voucher_pos_save

    attr_accessor :voucher_pos_delete
    ...
    def self.openapi_types
      {
        ...
        :'voucher_pos_save' => :'Array<ModelVoucherPos>',
        :'voucher_pos_delete' => :'SaveVoucherVoucherPosDelete',
        :'filename' => :'File'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SaveVoucher` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SaveVoucher`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'voucher_pos_save')
        if (value = attributes[:'voucher_pos_save']).is_a?(Array)
          self.voucher_pos_save = value
        end
      end

      if attributes.key?(:'voucher_pos_delete')
        self.voucher_pos_delete = attributes[:'voucher_pos_delete']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          voucher == o.voucher &&
          voucher_pos_save == o.voucher_pos_save &&
          voucher_pos_delete == o.voucher_pos_delete &&
          filename == o.filename
    end
    ...
    def hash
      [voucher, voucher_pos_save, voucher_pos_delete, filename].hash
    end
