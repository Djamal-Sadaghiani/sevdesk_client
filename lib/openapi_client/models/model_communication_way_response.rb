  ...
  class ModelCommunicationWayResponse
    ...
    def self.openapi_types
      {
        ...
        :'create' => :'Time',
        :'update' => :'Time',
        :'contact' => :'ModelCommunicationWayResponseContact',
        :'type' => :'String',
        :'value' => :'String',
        :'key' => :'ModelCommunicationWayResponseKey',
        :'main' => :'String',
        :'sev_client' => :'ModelCommunicationWayResponseSevClient'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelCommunicationWayResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelCommunicationWayResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["EMAIL", "PHONE", "WEB", "MOBILE"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["EMAIL", "PHONE", "WEB", "MOBILE"])
    ...
    def hash
      [id, object_name, create, update, contact, type, value, key, main, sev_client].hash
    end
