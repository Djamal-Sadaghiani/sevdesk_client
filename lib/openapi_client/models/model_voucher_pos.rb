  ...
  class ModelVoucherPos
    ...
    def self.openapi_types
      {
        ...
        :'create' => :'String',
        :'update' => :'String',
        :'sev_client' => :'ModelVoucherPosSevClient',
        :'voucher' => :'ModelVoucherPosVoucher',
        :'account_datev' => :'ModelVoucherPosAccountDatev',
        :'accounting_type' => :'ModelVoucherPosAccountingType',
        :'estimated_accounting_type' => :'ModelVoucherPosEstimatedAccountingType',
        :'tax_rate' => :'Float',
        :'net' => :'Boolean',
        :'is_asset' => :'Boolean',
        :'sum_net' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelVoucherPos` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelVoucherPos`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, object_name, map_all, create, update, sev_client, voucher, account_datev, accounting_type, estimated_accounting_type, tax_rate, net, is_asset, sum_net, sum_tax, sum_gross, sum_net_accounting, sum_tax_accounting, sum_gross_accounting, comment].hash
    end
