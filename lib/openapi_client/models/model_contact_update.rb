  ...
  class ModelContactUpdate
    ...
    def self.openapi_types
      {
        ...
        :'parent' => :'ModelContactUpdateParent',
        :'surename' => :'String',
        :'familyname' => :'String',
        :'titel' => :'String',
        :'category' => :'ModelContactUpdateCategory',
        :'description' => :'String',
        ...
        :'bank_account' => :'String',
        :'bank_number' => :'String',
        :'default_cashback_time' => :'Integer',
        :'default_cashback_percent' => :'Float',
        :'default_time_to_pay' => :'Integer',
        :'tax_number' => :'String',
        :'tax_office' => :'String',
        :'exempt_vat' => :'Boolean',
        :'default_discount_amount' => :'Float',
        :'default_discount_percentage' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelContactUpdate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelContactUpdate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [name, status, customer_number, parent, surename, familyname, titel, category, description, academic_title, gender, name2, birthday, vat_number, bank_account, bank_number, default_cashback_time, default_cashback_percent, default_time_to_pay, tax_number, tax_office, exempt_vat, default_discount_amount, default_discount_percentage, buyer_reference, government_agency].hash
    end
