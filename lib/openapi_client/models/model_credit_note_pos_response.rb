...
module OpenapiClient
  ...
  class ModelCreditNotePosResponse
    ...
    def self.openapi_types
      {
        ...
        :'create' => :'String',
        :'update' => :'String',
        :'credit_note' => :'ModelCreditNotePosResponseCreditNote',
        :'part' => :'ModelCreditNotePosResponsePart',
        :'quantity' => :'String',
        :'price' => :'String',
        :'price_net' => :'String',
        :'price_tax' => :'String',
        :'price_gross' => :'String',
        :'name' => :'String',
        :'unity' => :'ModelCreditNotePosResponseUnity',
        :'sev_client' => :'ModelCreditNotePosResponseSevClient',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelCreditNotePosResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelCreditNotePosResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, object_name, create, update, credit_note, part, quantity, price, price_net, price_tax, price_gross, name, unity, sev_client, position_number, text, discount, optional, tax_rate, sum_discount].hash
    end
