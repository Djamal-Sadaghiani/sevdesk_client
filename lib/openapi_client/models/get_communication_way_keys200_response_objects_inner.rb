...
module OpenapiClient
  class GetCommunicationWayKeys200ResponseObjectsInner
    # The id of the communication way key 1. ID: 1 - Privat 2. ID: 2 - Arbeit 3. ID: 3 - Fax 4. ID: 4 - Mobil 5. ID: 5 - \" \" 6. ID: 6 - Autobox 7. ID: 7 - Newsletter 8. ID: 8 - Rechnungsadresse
    attr_accessor :id
    ...
    attr_accessor :upadate

    # Name of the communication way key
    attr_accessor :name

    attr_accessor :translation_code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetCommunicationWayKeys200ResponseObjectsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetCommunicationWayKeys200ResponseObjectsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'upadate')
        self.upadate = attributes[:'upadate']
      end
      ...
      if attributes.key?(:'translation_code')
        self.translation_code = attributes[:'translation_code']
      end
    end
    ...
    def valid?
      ...
      name_validator = EnumAttributeValidator.new('String', ["Arbeit", "Autobox", "Fax", "Mobil", "Newsletter", "Privat", "Rechnungsadresse", " "])
    ...
    def name=(name)
      validator = EnumAttributeValidator.new('String', ["Arbeit", "Autobox", "Fax", "Mobil", "Newsletter", "Privat", "Rechnungsadresse", " "])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          upadate == o.upadate &&
          name == o.name &&
          translation_code == o.translation_code
    end
    ...
    def hash
      [id, object_name, create, upadate, name, translation_code].hash
    end
