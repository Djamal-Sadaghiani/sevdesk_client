...
module OpenapiClient
  class SaveInvoice
    ...
    attr_accessor :invoice_pos_save

    attr_accessor :invoice_pos_delete
    ...
    def self.openapi_types
      {
        ...
        :'invoice_pos_save' => :'Array<ModelInvoicePos>',
        :'invoice_pos_delete' => :'SaveInvoiceInvoicePosDelete',
        :'filename' => :'File',
        :'discount_save' => :'Array<SaveInvoiceDiscountSaveInner>',
        :'discount_delete' => :'SaveInvoiceDiscountDelete'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SaveInvoice` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SaveInvoice`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'invoice_pos_save')
        if (value = attributes[:'invoice_pos_save']).is_a?(Array)
          self.invoice_pos_save = value
        end
      end

      if attributes.key?(:'invoice_pos_delete')
        self.invoice_pos_delete = attributes[:'invoice_pos_delete']
      end
      ...
      if attributes.key?(:'discount_save')
        if (value = attributes[:'discount_save']).is_a?(Array)
          self.discount_save = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          invoice == o.invoice &&
          invoice_pos_save == o.invoice_pos_save &&
          invoice_pos_delete == o.invoice_pos_delete &&
          filename == o.filename &&
    ...
    def hash
      [invoice, invoice_pos_save, invoice_pos_delete, filename, discount_save, discount_delete].hash
    end
