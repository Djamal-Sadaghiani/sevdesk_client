...
module OpenapiClient
  ...
  class ModelContactCustomField
    attr_accessor :contact

    attr_accessor :contact_custom_field_setting
    ...
    def self.attribute_map
      {
        :'contact' => :'contact',
        :'contact_custom_field_setting' => :'contactCustomFieldSetting',
        :'value' => :'value',
    ...
    def self.openapi_types
      {
        :'contact' => :'ModelContactCustomFieldContact',
        :'contact_custom_field_setting' => :'ModelContactCustomFieldContactCustomFieldSetting',
        :'value' => :'String',
        :'object_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelContactCustomField` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelContactCustomField`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'contact_custom_field_setting')
        self.contact_custom_field_setting = attributes[:'contact_custom_field_setting']
      else
        self.contact_custom_field_setting = nil
      end
    ...
    def list_invalid_properties
      ...
      if @contact_custom_field_setting.nil?
        invalid_properties.push('invalid value for "contact_custom_field_setting", contact_custom_field_setting cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @contact_custom_field_setting.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          contact == o.contact &&
          contact_custom_field_setting == o.contact_custom_field_setting &&
          value == o.value &&
    ...
    def hash
      [contact, contact_custom_field_setting, value, object_name].hash
    end
