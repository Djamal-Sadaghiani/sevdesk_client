...
module OpenapiClient
  ...
  class ModelCheckAccountTransactionResponse
    ...
    def self.openapi_types
      {
        ...
        :'create' => :'Time',
        :'update' => :'Time',
        :'sev_client' => :'ModelCheckAccountTransactionResponseSevClient',
        :'value_date' => :'Time',
        :'entry_date' => :'Time',
        ...
        :'check_account' => :'ModelCheckAccountTransactionResponseCheckAccount',
        :'status' => :'String',
        :'source_transaction' => :'ModelCheckAccountTransactionResponseSourceTransaction',
        :'target_transaction' => :'ModelCheckAccountTransactionResponseTargetTransaction',
        :'enshrined' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelCheckAccountTransactionResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelCheckAccountTransactionResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'gv_code')
        self.gv_code = attributes[:'gv_code']
      end

      if attributes.key?(:'entry_text')
        self.entry_text = attributes[:'entry_text']
      end

      if attributes.key?(:'prima_nota_no')
        self.prima_nota_no = attributes[:'prima_nota_no']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["100", "200", "300", "350", "400"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["100", "200", "300", "350", "400"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          gv_code == o.gv_code &&
          entry_text == o.entry_text &&
          prima_nota_no == o.prima_nota_no &&
    ...
    def hash
      [id, object_name, create, update, sev_client, value_date, entry_date, paymt_purpose, amount, payee_payer_name, payee_payer_acct_no, payee_payer_bank_code, gv_code, entry_text, prima_nota_no, check_account, status, source_transaction, target_transaction, enshrined].hash
    end
