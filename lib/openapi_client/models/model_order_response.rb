  ...
  class ModelOrderResponse
    ...
    def self.openapi_types
      {
        ...
        :'update' => :'Time',
        :'order_number' => :'String',
        :'contact' => :'ModelOrderResponseContact',
        :'order_date' => :'Time',
        :'status' => :'String',
        :'header' => :'String',
        :'head_text' => :'String',
        :'foot_text' => :'String',
        :'address_country' => :'ModelOrderResponseAddressCountry',
        :'create_user' => :'ModelOrderResponseCreateUser',
        :'sev_client' => :'ModelOrderResponseSevClient',
        :'delivery_terms' => :'String',
        :'payment_terms' => :'String',
        :'origin' => :'ModelOrderResponseOrigin',
        :'version' => :'String',
        :'small_settlement' => :'Boolean',
        :'contact_person' => :'ModelOrderResponseContactPerson',
        :'tax_rate' => :'String',
        :'tax_rule' => :'ModelOrderResponseTaxRule',
        :'tax_set' => :'ModelOrderResponseTaxSet',
        :'tax_text' => :'String',
        :'tax_type' => :'String',
        :'order_type' => :'String',
        :'send_date' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ModelOrderResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ModelOrderResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
