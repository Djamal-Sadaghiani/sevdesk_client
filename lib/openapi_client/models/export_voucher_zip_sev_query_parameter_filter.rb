...
module OpenapiClient
  class ExportVoucherZipSevQueryParameterFilter
    ...
    attr_accessor :start_pay_date

    # End pay date of the voucher
    attr_accessor :end_pay_date
    ...
    def self.attribute_map
      {
        ...
        :'end_date' => :'endDate',
        :'start_pay_date' => :'startPayDate',
        :'end_pay_date' => :'endPayDate',
        :'contact' => :'contact',
    ...
    def self.openapi_types
      {
        ...
        :'start_pay_date' => :'Time',
        :'end_pay_date' => :'Time',
        :'contact' => :'ExportVoucherZipSevQueryParameterFilterContact',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ExportVoucherZipSevQueryParameterFilter` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ExportVoucherZipSevQueryParameterFilter`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'start_pay_date')
        self.start_pay_date = attributes[:'start_pay_date']
      end

      if attributes.key?(:'end_pay_date')
        self.end_pay_date = attributes[:'end_pay_date']
      end
      ...
      if attributes.key?(:'start_amount')
        self.start_amount = attributes[:'start_amount']
      end

      if attributes.key?(:'end_amount')
        self.end_amount = attributes[:'end_amount']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          start_pay_date == o.start_pay_date &&
          end_pay_date == o.end_pay_date &&
          contact == o.contact &&
          start_amount == o.start_amount &&
          end_amount == o.end_amount
    end
    ...
    def hash
      [start_date, end_date, start_pay_date, end_pay_date, contact, start_amount, end_amount].hash
    end
