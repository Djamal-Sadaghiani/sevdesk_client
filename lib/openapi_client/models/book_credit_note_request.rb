  ...
  class BookCreditNoteRequest
    ...
    def self.attribute_map
      {
        ...
        :'check_account_transaction' => :'checkAccountTransaction',
    ...
    def self.openapi_types
      {
        ...
        :'date' => :'Integer',
        :'type' => :'String',
        :'check_account' => :'BookCreditNoteRequestCheckAccount',
        :'check_account_transaction' => :'BookCreditNoteRequestCheckAccountTransaction',
        :'create_feed' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BookCreditNoteRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BookCreditNoteRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'check_account_transaction')
        self.check_account_transaction = attributes[:'check_account_transaction']
      end

      if attributes.key?(:'create_feed')
        self.create_feed = attributes[:'create_feed']
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["FULL_PAYMENT", "N", "CB", "CF", "O", "OF", "MTC"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["FULL_PAYMENT", "N", "CB", "CF", "O", "OF", "MTC"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          check_account_transaction == o.check_account_transaction &&
          create_feed == o.create_feed
    end
    ...
    def hash
      [amount, date, type, check_account, check_account_transaction, create_feed].hash
    end
