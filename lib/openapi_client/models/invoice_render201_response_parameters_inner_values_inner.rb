...
module OpenapiClient
  class InvoiceRender201ResponseParametersInnerValuesInner
    attr_accessor :name

    attr_accessor :translation_cade
    ...
    def self.attribute_map
      {
        :'name' => :'name',
        :'translation_cade' => :'translationCade',
        :'value' => :'value'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InvoiceRender201ResponseParametersInnerValuesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InvoiceRender201ResponseParametersInnerValuesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'translation_cade')
        self.translation_cade = attributes[:'translation_cade']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          name == o.name &&
          translation_cade == o.translation_cade &&
          value == o.value
    end
    ...
    def hash
      [name, translation_cade, value].hash
    end
