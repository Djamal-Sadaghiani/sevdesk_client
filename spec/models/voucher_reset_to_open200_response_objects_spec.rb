...
# Unit tests for OpenapiClient::VoucherResetToOpen200ResponseObjects
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VoucherResetToOpen200ResponseObjects do
  let(:instance) { OpenapiClient::VoucherResetToOpen200ResponseObjects.new }

  describe 'test an instance of VoucherResetToOpen200ResponseObjects' do
    it 'should create an instance of VoucherResetToOpen200ResponseObjects' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::VoucherResetToOpen200ResponseObjects)
    end
  end
