...
# Unit tests for OpenapiClient::ModelInvoiceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelInvoiceResponse do
  let(:instance) { OpenapiClient::ModelInvoiceResponse.new }

  describe 'test an instance of ModelInvoiceResponse' do
    it 'should create an instance of ModelInvoiceResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelInvoiceResponse)
    end
  end
