...
# Unit tests for OpenapiClient::ModelCreditNoteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelCreditNoteResponse do
  let(:instance) { OpenapiClient::ModelCreditNoteResponse.new }

  describe 'test an instance of ModelCreditNoteResponse' do
    it 'should create an instance of ModelCreditNoteResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelCreditNoteResponse)
    end
  end
