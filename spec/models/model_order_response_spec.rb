...
# Unit tests for OpenapiClient::ModelOrderResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelOrderResponse do
  let(:instance) { OpenapiClient::ModelOrderResponse.new }

  describe 'test an instance of ModelOrderResponse' do
    it 'should create an instance of ModelOrderResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelOrderResponse)
    end
  end
