...
# Unit tests for OpenapiClient::CreditNoteResetToDraft200ResponseObjects
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreditNoteResetToDraft200ResponseObjects do
  let(:instance) { OpenapiClient::CreditNoteResetToDraft200ResponseObjects.new }

  describe 'test an instance of CreditNoteResetToDraft200ResponseObjects' do
    it 'should create an instance of CreditNoteResetToDraft200ResponseObjects' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreditNoteResetToDraft200ResponseObjects)
    end
  end
