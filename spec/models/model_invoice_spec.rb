...
# Unit tests for OpenapiClient::ModelInvoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelInvoice do
  let(:instance) { OpenapiClient::ModelInvoice.new }

  describe 'test an instance of ModelInvoice' do
    it 'should create an instance of ModelInvoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelInvoice)
    end
  end
  ...
  describe 'test attribute "property_is_e_invoice"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
