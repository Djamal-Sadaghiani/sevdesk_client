...
# Unit tests for OpenapiClient::CreditNoteResetToOpen200ResponseObjects
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreditNoteResetToOpen200ResponseObjects do
  let(:instance) { OpenapiClient::CreditNoteResetToOpen200ResponseObjects.new }

  describe 'test an instance of CreditNoteResetToOpen200ResponseObjects' do
    it 'should create an instance of CreditNoteResetToOpen200ResponseObjects' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreditNoteResetToOpen200ResponseObjects)
    end
  end
