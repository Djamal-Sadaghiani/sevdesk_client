...
# Unit tests for OpenapiClient::ModelCreditNote
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelCreditNote do
  let(:instance) { OpenapiClient::ModelCreditNote.new }

  describe 'test an instance of ModelCreditNote' do
    it 'should create an instance of ModelCreditNote' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelCreditNote)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["100", "200", "300", "500", "750", "1000"])
  ...
  describe 'test attribute "booking_category"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PROVISION", "ROYALTY_ASSIGNED", "ROYALTY_UNASSIGNED", "UNDERACHIEVEMENT", "ACCOUNTING_TYPE"])
      # validator.allowable_values.each do |value|
      #   expect { instance.booking_category = value }.not_to raise_error
      # end
    end
  end
