...
# Unit tests for OpenapiClient::InvoiceResetToDraft200ResponseObjects
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvoiceResetToDraft200ResponseObjects do
  let(:instance) { OpenapiClient::InvoiceResetToDraft200ResponseObjects.new }

  describe 'test an instance of InvoiceResetToDraft200ResponseObjects' do
    it 'should create an instance of InvoiceResetToDraft200ResponseObjects' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::InvoiceResetToDraft200ResponseObjects)
    end
  end
