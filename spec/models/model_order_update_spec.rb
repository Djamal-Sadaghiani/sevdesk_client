...
# Unit tests for OpenapiClient::ModelOrderUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelOrderUpdate do
  let(:instance) { OpenapiClient::ModelOrderUpdate.new }

  describe 'test an instance of ModelOrderUpdate' do
    it 'should create an instance of ModelOrderUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelOrderUpdate)
    end
  end
