...
# Unit tests for OpenapiClient::ModelVoucherResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelVoucherResponse do
  let(:instance) { OpenapiClient::ModelVoucherResponse.new }

  describe 'test an instance of ModelVoucherResponse' do
    it 'should create an instance of ModelVoucherResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ModelVoucherResponse)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["50", "100", "1000"])
